    ...
    exists (
      ...
      where ur.user_id = (select auth.uid())
        and (
          ...
          or (event_type = 'alumni_event' and ur.role_slug in ('alumni-chair', 'alumni-chairman'))
          ...
          or (event_type = 'professional_development' and ur.role_slug in ('professional-dev', 'professional-dev-chair', 'professional-development', 'professional-development-chair'))
